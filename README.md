...
This repository is part of the paper: Mapping deforestation using fractions indices and the PVts-?? approach (submitted to IEEE Geoscience and Remote Sensing Letters).
